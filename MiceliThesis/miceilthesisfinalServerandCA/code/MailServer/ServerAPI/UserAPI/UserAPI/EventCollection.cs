    ...
    public class EventCollection : IEnumerable
    {
        ...
        private void Bind()
        {
            ...
            */
            ...
            lock(m_pOwner){
                // Call TCP GetEvents
                m_pOwner.Socket.WriteLine("GetEvents");

                string response = m_pOwner.Socket.ReadLine();
                ...
                m_pOwner.Socket.ReadSpecifiedLength(sizeOfData,ms);
        ...
        public void Clear()
        {
            ...
            */
            ...
            // Call TCP GetEvents
            m_pOwner.Socket.WriteLine("ClearEvents");
