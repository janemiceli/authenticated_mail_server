    ...
    public class MailingListMemberCollection : IEnumerable
    {
        ...
        public void Add(string member)
        {
            ...
            */
            ...
            m_pMailingList.VirtualServer.Server.Socket.WriteLine("AddMailingListMember " + m_pMailingList.VirtualServer.VirtualServerID + " " + TextUtils.QuoteString(m_pMailingList.ID) + " " + TextUtils.QuoteString(member));
        ...
        public void Remove(string member)
        {
            ...
            */
            ...
            // Call TCP AddMailingListMember
            m_pMailingList.VirtualServer.Server.Socket.WriteLine("DeleteMailingListMember " + m_pMailingList.VirtualServer.VirtualServerID + " " + TextUtils.QuoteString(m_pMailingList.ID) + " " + TextUtils.QuoteString(member));
        ...
        {            
            ...
            */
            ...
            lock(m_pMailingList.VirtualServer.Server.LockSynchronizer){
                ...
                m_pMailingList.VirtualServer.Server.Socket.WriteLine("GetMailingListMembers " + m_pMailingList.VirtualServer.VirtualServerID + " " + m_pMailingList.ID);
