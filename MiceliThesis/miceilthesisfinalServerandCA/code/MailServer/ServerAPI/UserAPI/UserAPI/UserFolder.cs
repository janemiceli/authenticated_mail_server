    ...
    public class UserFolder
    {
        ...
        public void Rename(string newFolderName)
        {
            ...
            */
            ...
            m_pUser.VirtualServer.Server.Socket.WriteLine("RenameUserFolder " + 
        ...
        public DataSet GetMessagesInfo()
        {
            ...
            */
            ...
            lock(m_pUser.VirtualServer.Server.LockSynchronizer){
                ...
                m_pUser.VirtualServer.Server.Socket.WriteLine("GetUserFolderMessagesInfo " + 
                    m_pUser.VirtualServer.VirtualServerID + " " +
                    TextUtils.QuoteString(m_pUser.UserName) + " " + 
                    TextUtils.QuoteString(this.FolderFullPath)
                );
        ...
        public void DeleteMessage(string messageID,long uid)
        {
            ...
            */
            ...
            m_pUser.VirtualServer.Server.Socket.WriteLine("DeleteUserFolderMessage " + 
                m_pUser.VirtualServer.VirtualServerID + " " + 
                TextUtils.QuoteString(m_pUser.UserName) + " " + 
                TextUtils.QuoteString(this.FolderFullPath) + " " +
        ...
        public void GetMessage(string messageID,Stream message)
        {
            ...
            */
            ...
            m_pUser.VirtualServer.Server.Socket.WriteLine("GetUserFolderMessage " +
                m_pUser.VirtualServer.VirtualServerID + " " + 
                TextUtils.QuoteString(m_pUser.UserName) + " " + 
                TextUtils.QuoteString(this.FolderFullPath) + " " +
                TextUtils.QuoteString(messageID)
            ...
            m_pUser.VirtualServer.Server.Socket.ReadSpecifiedLength(size,message);
        }
        ...
        public void StoreMessage(Stream message)
        {
            ...
            */
            ...
            m_pUser.VirtualServer.Server.Socket.WriteLine("StoreUserFolderMessage " +
                m_pUser.VirtualServer.VirtualServerID + " " + 
                TextUtils.QuoteString(m_pUser.UserName) + " " + 
                TextUtils.QuoteString(this.FolderFullPath) + " " +
            ...
            m_pUser.VirtualServer.Server.Socket.Write(message);

            response = m_pUser.VirtualServer.Server.Socket.ReadLine();
            if(!response.ToUpper().StartsWith("+OK")){
                throw new Exception(response);
            }
        }
        ...
        private string[] GetFolderInfo()
        {
            ...
            */
            ...
            m_pUser.VirtualServer.Server.Socket.WriteLine("GetUserFolderInfo " + 
                m_pUser.VirtualServer.VirtualServerID + " " + 
                TextUtils.QuoteString(m_pUser.UserName) + " " + 
                TextUtils.QuoteString(this.FolderFullPath)
            );
