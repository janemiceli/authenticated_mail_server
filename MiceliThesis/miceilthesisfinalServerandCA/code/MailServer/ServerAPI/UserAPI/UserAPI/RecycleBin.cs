    ...
    public class RecycleBin
    {
        ...
        public DataTable GetMessagesInfo(string user,DateTime startDate,DateTime endDate)
        {
            ...
            */
            ...
            lock(m_pVirtualServer.Server.LockSynchronizer){
                ...
                m_pVirtualServer.Server.Socket.WriteLine("GetRecycleBinMessagesInfo " + 
        ...
        public void GetMessage(string messageID,Stream message)
        {
            ...
            */
            ...
            m_pVirtualServer.Server.Socket.WriteLine("GetRecycleBinMessage " +
                m_pVirtualServer.VirtualServerID + " " + 
            ...
            m_pVirtualServer.Server.Socket.ReadSpecifiedLength(size,message);
        }
        ...
        public void RestoreRecycleBinMessage(string messageID)
        {
            ...
            */
            ...
            m_pVirtualServer.Server.Socket.WriteLine("RestoreRecycleBinMessage " + 
                m_pVirtualServer.VirtualServerID + " " +
                messageID
            );
        ...
        private void Bind()
        {
            ...
            */
            ...
            m_pVirtualServer.Server.Socket.WriteLine("GetRecycleBinSettings " + m_pVirtualServer.VirtualServerID);
        ...
        public void Commit()
        {
            ...
            */
            ...
            m_pVirtualServer.Server.Socket.WriteLine("UpdateRecycleBinSettings " + 
                m_pVirtualServer.VirtualServerID + " " + 
