    ...
    public class MailingList
    {
        ...
        public void Commit()
        {
            ...
            */
            ...
            m_pVirtualServer.Server.Socket.WriteLine("UpdateMailingList " + m_pVirtualServer.VirtualServerID + " " + TextUtils.QuoteString(m_ID) + " " + TextUtils.QuoteString(m_Name) + " " + TextUtils.QuoteString(m_Description) + " " + m_Enabled);
