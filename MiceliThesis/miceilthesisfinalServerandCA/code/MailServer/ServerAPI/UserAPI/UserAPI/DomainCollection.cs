    ...
    public class DomainCollection : IEnumerable
    {
        ...
        public Domain Add(string name,string description)
        {
            ...
            */
            ...
            // Call TCP AddGroup
            m_pVirtualServer.Server.Socket.WriteLine("AddDomain " + m_pVirtualServer.VirtualServerID + " " + TextUtils.QuoteString(id) + " " + TextUtils.QuoteString(name) + " " + TextUtils.QuoteString(description));
        ...
        public void Remove(Domain domain)
        {
            ...
            */
            ...
            m_pVirtualServer.Server.Socket.WriteLine("DeleteDomain " + m_pVirtualServer.VirtualServerID + " " + TextUtils.QuoteString(domain.DomainID));
        ...
        private void Bind()
        {
            ...
            */
            ...
            lock(m_pVirtualServer.Server.LockSynchronizer){
                // Call TCP GetDomains
                m_pVirtualServer.Server.Socket.WriteLine("GetDomains " + m_pVirtualServer.VirtualServerID);
