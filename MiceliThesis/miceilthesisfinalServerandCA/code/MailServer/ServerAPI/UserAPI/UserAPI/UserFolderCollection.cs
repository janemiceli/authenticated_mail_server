    ...
    public class UserFolderCollection : IEnumerable
    {
        ...
        public UserFolder Add(string newFolder)
        {
            ...
            */
            ...
            m_pUser.VirtualServer.Server.Socket.WriteLine("AddUserFolder " + m_pUser.VirtualServer.VirtualServerID + " " + TextUtils.QuoteString(m_pUser.UserName) + " " + TextUtils.QuoteString(folderFullPath));
        ...
        public void Remove(UserFolder folder)
        {
            ...
            */
            ...
            m_pUser.VirtualServer.Server.Socket.WriteLine("DeleteUserFolder " + m_pUser.VirtualServer.VirtualServerID + " " + TextUtils.QuoteString(m_pUser.UserName) + " " + TextUtils.QuoteString(folder.FolderFullPath));
        ...
        {            
            ...
            */
            ...
            lock(m_pUser.VirtualServer.Server.LockSynchronizer){
                ...
                m_pUser.VirtualServer.Server.Socket.WriteLine("GetUserFolders " + m_pUser.VirtualServer.VirtualServerID + " " + m_pUser.UserID);
