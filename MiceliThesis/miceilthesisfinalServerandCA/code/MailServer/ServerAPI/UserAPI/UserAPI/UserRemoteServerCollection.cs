    ...
    public class UserRemoteServerCollection : IEnumerable
    {
        ...
        public UserRemoteServer Add(string description,string host,int port,bool ssl,string userName,string password,bool enabled)
        {
            ...
            */
            ...
            m_pUser.VirtualServer.Server.Socket.WriteLine("AddUserRemoteServer " + 
        ...
        public void Remove(UserRemoteServer remoteServer)
        {
            ...
            */
            ...
            m_pUser.VirtualServer.Server.Socket.WriteLine("DeleteUserRemoteServer " + m_pUser.VirtualServer.VirtualServerID + " " + TextUtils.QuoteString(remoteServer.ID));
        ...
        {            
            ...
            */
            ...
            lock(m_pUser.VirtualServer.Server.LockSynchronizer){
                ...
                m_pUser.VirtualServer.Server.Socket.WriteLine("GetUserRemoteServers " + m_pUser.VirtualServer.VirtualServerID + " " + m_pUser.UserID);
