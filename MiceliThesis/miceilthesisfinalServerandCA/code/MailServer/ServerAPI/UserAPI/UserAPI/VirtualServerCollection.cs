...
namespace LumiSoft.MailServer.API.UserAPI
{
    ...
    public class VirtualServerCollection : IEnumerable
    {
        ...
        public DataSet GetVirtualServerAPIs()
        {
            ...
            */
            ...
            lock(m_pParent){
                ...
                m_pParent.Socket.WriteLine("GetVirtualServerAPIs");

                string response = m_pParent.Socket.ReadLine();
                ...
                m_pParent.Socket.ReadSpecifiedLength(sizeOfData,ms);
        ...
        public void Add(bool enabled,string name,string assembly,string type,string initString)
        {
            ...
            */
            ...
            m_pParent.Socket.WriteLine("AddVirtualServer " + 
                id + " " +
                enabled + " " +
        ...
        public void Remove(VirtualServer server)
        {
            ...
            */
            ...
            m_pParent.Socket.WriteLine("DeleteVirtualServer " + server.VirtualServerID);
        ...
        {            
            ...
            */
            ...
            lock(m_pParent){
                ...
                m_pParent.Socket.WriteLine("GetVirtualServers");
