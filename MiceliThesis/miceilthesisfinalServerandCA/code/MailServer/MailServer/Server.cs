            ...
            get{
                ...
                foreach(VirtualServer virtualServer in m_pVirtualServers){
                    if(virtualServer.Enabled){
                        sessions.AddRange(virtualServer.SmtpServer.Sessions);
                        sessions.AddRange(virtualServer.Pop3Server.Sessions);
                        sessions.AddRange(virtualServer.ImapServer.Sessions);
                        sessions.AddRange(virtualServer.RelayServer.Sessions);                        
                    }
                }
                sessions.AddRange(m_pManagementServer.Sessions);
