...
namespace LumiSoft.MailServer
{
	...
	internal class FetchPop3 : IDisposable
	{
		...
		/// <param name="e"></param>
		private void clnt_SessionLog(object sender, Log_EventArgs e)
		{
            Logger.WriteLog(m_LogPath + "fetch-" + DateTime.Today.ToString("yyyyMMdd") + ".log",e.Logger);
        }
