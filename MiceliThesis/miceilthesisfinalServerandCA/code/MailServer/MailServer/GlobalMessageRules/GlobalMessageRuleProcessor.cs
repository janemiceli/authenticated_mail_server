      ...
      //    bool   messageChanged = false;
            ...
            foreach(DataRowView drV in dvActions){               
                ...
                */
                ...
                if(action == GlobalMessageRuleAction_enum.AutoResponse){
                    ...
                    if(header.Contains("X-LS-MailServer-AutoResponse:")){
                        ...
                        autoresponseMessage.MainEntity.Header.Add("X-LS-MailServer-AutoResponse:","");
                        // Update message date
                ...
                */
                    ...
                    mime.MainEntity.Header.Add(table.GetValue("HeaderFieldName"),table.GetValue("HeaderFieldValue"));
                    message.SetLength(0);
                    mime.ToStream(message);
                ...
                */
                    ...
                    Mime mime = Mime.Parse(message);
                    mime.MainEntity.Header.RemoveAll(table.GetValue("HeaderFieldName"));
                    message.SetLength(0);
                    mime.ToStream(message);
                ...
                */
                    ...
                    Mime mime = Mime.Parse(message);
                    if(!mime.MainEntity.Header.Contains("Newsgroups:")){
                        mime.MainEntity.Header.Add("Newsgroups:",table.GetValue("Newsgroup"));
                    }
