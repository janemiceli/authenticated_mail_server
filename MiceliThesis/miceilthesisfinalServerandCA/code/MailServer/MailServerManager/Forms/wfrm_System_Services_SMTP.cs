...
namespace LumiSoft.MailServer.UI
{
    ...
    public class wfrm_System_Services_SMTP : Form
    {
        ...
        private void InitUI()
        {
            ...
            mt_HostName.Size = new Size(164,20);
            mt_HostName.Location = new Point(1,40);
            ...
            mt_GreetingText.Location = new Point(1,65);
            ...
            mt_DefaultDomain.Location = new Point(1,90);
            ...
            m_pDefaultDomain.Location = new Point(170,90);

            mt_SessionTimeout = new Label();
            mt_SessionTimeout.Size = new Size(164,20);
            mt_SessionTimeout.Location = new Point(1,130);
            ...
            mt_MaxConnections.Location = new Point(1,170);
            ...
            mt_MaxBadCommands.Location = new Point(1,220);
            ...
            mt_MaxRecipients.Location = new Point(1,245);
            ...
            m_pMaxRecipients.Location = new Point(170,245);
            ...
            mt_MaxMessageSize.Location = new Point(1,270);
            ...
            m_pRequireAuth.Location = new Point(170,300);
        ...
        {
            wfrm_sys_BindInfo frm = new wfrm_sys_BindInfo(m_pVirtualServer.Server,25,465);
