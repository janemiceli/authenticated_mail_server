    ...
    public class UsersDefaultFolderCollection : IEnumerable
    {
        ...
        public UsersDefaultFolder Add(string folderName,bool permanent)
        {
            ...
            */
            ...
            m_pVirtualServer.Server.Socket.WriteLine("AddUsersDefaultFolder " + 
        ...
        public void Remove(UsersDefaultFolder folder)
        {
            ...
            */
            ...
            m_pVirtualServer.Server.Socket.WriteLine("DeleteUsersDefaultFolder " + 
                m_pVirtualServer.VirtualServerID + " " + 
        ...
        private void Bind()
        {
            ...
            */
            ...
            lock(m_pVirtualServer.Server.LockSynchronizer){
                ...
                m_pVirtualServer.Server.Socket.WriteLine("GetUsersDefaultFolders " + m_pVirtualServer.VirtualServerID);
