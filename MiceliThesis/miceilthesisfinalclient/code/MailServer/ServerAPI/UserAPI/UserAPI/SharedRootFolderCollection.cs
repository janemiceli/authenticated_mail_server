    ...
    public class SharedRootFolderCollection : IEnumerable
    {
        ...
        public SharedRootFolder Add(bool enabled,string name,string description,SharedFolderRootType_enum type,string boundedUser,string boundedFolder)
        {
            ...
            */
            ...
            m_pVirtualServer.Server.Socket.WriteLine("AddSharedRootFolder " + 
        ...
        public void Remove(SharedRootFolder sharedFolder)
        {
            ...
            */
            ...
            m_pVirtualServer.Server.Socket.WriteLine("DeleteSharedRootFolder " + m_pVirtualServer.VirtualServerID + " " + TextUtils.QuoteString(sharedFolder.ID));
        ...
        private void Bind()
        {
            ...
            */
            ...
            lock(m_pVirtualServer.Server.LockSynchronizer){
                ...
                m_pVirtualServer.Server.Socket.WriteLine("GetSharedRootFolders " + m_pVirtualServer.VirtualServerID);
