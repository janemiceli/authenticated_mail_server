    ...
    public class MailingListCollection : IEnumerable
    {
        ...
        public MailingList Add(string name,string description,bool enabled)
        {
            ...
            */
            ...
            m_pVirtualServer.Server.Socket.WriteLine("AddMailingList " + m_pVirtualServer.VirtualServerID + " " + TextUtils.QuoteString(id) + " " + TextUtils.QuoteString(name) + " " + TextUtils.QuoteString(description) + " " + enabled);
        ...
        public void Remove(MailingList mailingList)
        {
            ...
            */
            ...
            m_pVirtualServer.Server.Socket.WriteLine("DeleteMailingList " + m_pVirtualServer.VirtualServerID + " " + TextUtils.QuoteString(mailingList.ID));
        ...
        {            
            ...
            */
            ...
            lock(m_pVirtualServer.Server.LockSynchronizer){
                ...
                m_pVirtualServer.Server.Socket.WriteLine("GetMailingLists " + m_pVirtualServer.VirtualServerID);
