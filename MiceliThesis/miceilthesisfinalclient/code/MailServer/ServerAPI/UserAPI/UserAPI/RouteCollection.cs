    ...
    public class RouteCollection : IEnumerable
    {
        ...
        public Route Add(string description,string pattern,bool enabled,RouteActionBase action)
        {
            ...
            */
            ...
            // Call TCP AddRoute
            m_pVirtualServer.Server.Socket.WriteLine("AddRoute " + 
        ...
        public void Remove(Route route)
        {
            ...
            */
            ...
            m_pVirtualServer.Server.Socket.WriteLine("DeleteRoute " + m_pVirtualServer.VirtualServerID + " " + TextUtils.QuoteString(route.ID));
        ...
        private void Bind()
        {
            ...
            */
            ...
            lock(m_pVirtualServer.Server.LockSynchronizer){
                // Call TCP GetRoutes
                m_pVirtualServer.Server.Socket.WriteLine("GetRoutes " + m_pVirtualServer.VirtualServerID);
