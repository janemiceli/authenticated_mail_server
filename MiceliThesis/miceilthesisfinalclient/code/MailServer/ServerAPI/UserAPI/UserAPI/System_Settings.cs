    ...
    public class System_Settings
    {
        ...
        public void Commit()
        {
            ...
            */
            ...
            m_pVirtualServer.Server.Socket.WriteLine("UpdateSettings " + 
                m_pVirtualServer.VirtualServerID + " " + 
                settingsData.Length.ToString()
            );
            m_pVirtualServer.Server.Socket.Write(settingsData);
        ...
        internal DataSet ToDataSet()
        {
            ...
            dr["SMTP_HostName"]            = this.SMTP.HostName;
            ...
            dr["POP3_HostName"]            = this.POP3.HostName;
            ...
            // Add IP binds
            foreach(BindInfo bindInfo in this.POP3.Binds){
            ...
            dr["IMAP_HostName"]            = this.IMAP.HostName;
            ...
            // Add IP binds
            foreach(BindInfo bindInfo in this.IMAP.Binds){
            ...
            dr["UseSmartHost"]               = this.Relay.UseSmartHost;
            dr["SmartHost"]                  = this.Relay.SmartHost;
            dr["SmartHostPort"]              = this.Relay.SmartHostPort;
            dr["Relay_SmartHost_UseSSL"]     = this.Relay.SmartHostSsl;
            dr["SmartHostUserName"]          = this.Relay.SmartHostUserName;
            dr["SmartHostPassword"]          = this.Relay.SmartHostPassword;
            dr["Dns1"]                       = this.Relay.Dns1;
            dr["Dns2"]                       = this.Relay.Dns2;
            dr["Relay_HostName"]             = this.Relay.HostName;
            ...
            dr["RelayLocalIP"]               = this.Relay.BindIP;
            ...
            dr["SIP_HostName"]   = this.SIP.HostName;
            dr["SIP_MinExpires"] = this.SIP.MinimumExpires;
            // Add IP binds
            foreach(BindInfo bindInfo in this.SIP.Binds){
