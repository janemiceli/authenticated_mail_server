    ...
    public class GroupCollection : IEnumerable
    {
        ...
        public Group Add(string name,string description,bool enabled)
        {
            ...
            */
            ...
            // Call TCP AddGroup
            m_pVirtualServer.Server.Socket.WriteLine("AddGroup " + m_pVirtualServer.VirtualServerID + " " + TextUtils.QuoteString(id) + " " + TextUtils.QuoteString(name) + " " + TextUtils.QuoteString(description) + " " + enabled);
        ...
        public void Remove(Group group)
        {
            ...
            */
            ...
            m_pVirtualServer.Server.Socket.WriteLine("DeleteGroup " + m_pVirtualServer.VirtualServerID + " " + TextUtils.QuoteString(group.GroupID));
        ...
        private void Bind()
        {
            ...
            */
            ...
            lock(m_pVirtualServer.Server.LockSynchronizer){
                // Call TCP GetGroups
                m_pVirtualServer.Server.Socket.WriteLine("GetGroups " + m_pVirtualServer.VirtualServerID);
