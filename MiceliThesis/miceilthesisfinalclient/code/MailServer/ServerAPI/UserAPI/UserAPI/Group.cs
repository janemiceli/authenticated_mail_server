    ...
    public class Group
    {
        ...
        public void Commit()
        {
            ...
            */
            ...
            m_pVirtualServer.Server.Socket.WriteLine("UpdateGroup " + m_pVirtualServer.VirtualServerID + " " + TextUtils.QuoteString(m_GroupID) + " " + TextUtils.QuoteString(m_GroupName) + " " + TextUtils.QuoteString(m_Description) + " " + m_Enabled);
