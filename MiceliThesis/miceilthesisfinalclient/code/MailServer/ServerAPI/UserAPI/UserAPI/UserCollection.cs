    ...
    public class UserCollection : IEnumerable
    {
        ...
        public User Add(string userName,string fullName,string password,string description,int mailboxSize,bool enabled,UserPermissions_enum permissions)
        {
            ...
            */
            ...
            // Call TCP AddUser
            m_pVirtualServer.Server.Socket.WriteLine("AddUser " + 
        ...
        public void Remove(User user)
        {
            ...
            */
            ...
            // Call TCP DeleteUser
            m_pVirtualServer.Server.Socket.WriteLine("DeleteUser " + m_pVirtualServer.VirtualServerID + " " + TextUtils.QuoteString(user.UserID));
        ...
        {            
            ...
            */
            ...
            lock(m_pVirtualServer.Server.LockSynchronizer){
                // Call TCP GetUsers
                m_pVirtualServer.Server.Socket.WriteLine("GetUsers " + m_pVirtualServer.VirtualServerID);
