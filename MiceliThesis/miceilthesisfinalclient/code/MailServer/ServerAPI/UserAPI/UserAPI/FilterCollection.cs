        ...
        public DataSet GetFilterTypes()
        {
            ...
            */
            ...
            lock(m_pVirtualServer.Server){
                ...
                m_pVirtualServer.Server.Socket.WriteLine("GetFilterTypes " + m_pVirtualServer.VirtualServerID);
        ...
        private void Bind()
        {
            ...
            */
            ...
            lock(m_pVirtualServer.Server.LockSynchronizer){
                // Call TCP GetFilters
                m_pVirtualServer.Server.Socket.WriteLine("GetFilters " + m_pVirtualServer.VirtualServerID);
