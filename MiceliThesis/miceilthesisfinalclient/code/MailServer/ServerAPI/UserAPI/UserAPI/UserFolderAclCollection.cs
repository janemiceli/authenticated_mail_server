    ...
    public class UserFolderAclCollection : IEnumerable
    {
        ...
        public UserFolderAcl Add(string userOrGroup,IMAP_ACL_Flags permissions)
        {
            ...
            */
            ...
            m_pFolder.User.VirtualServer.Server.Socket.WriteLine("SetUserFolderAcl " + m_pFolder.User.VirtualServer.VirtualServerID + " " + TextUtils.QuoteString(m_pFolder.User.UserName) + " " + TextUtils.QuoteString(m_pFolder.FolderFullPath) + " " + TextUtils.QuoteString(userOrGroup) + " " + (int)permissions);
                        
            string response = m_pFolder.User.VirtualServer.Server.Socket.ReadLine();
        ...
        public void Remove(UserFolderAcl aclEntry)
        {
            ...
            */
            ...
            m_pFolder.User.VirtualServer.Server.Socket.WriteLine("DeleteUserFolderAcl " + 
        ...
        private void Bind()
        {
            ...
            */
            ...
            lock(m_pFolder.User.VirtualServer.Server.LockSynchronizer){
                ...
                m_pFolder.User.VirtualServer.Server.Socket.WriteLine("GetUserFolderAcl " + 
                    m_pFolder.User.VirtualServer.VirtualServerID + " " + 
                ...
                m_pFolder.User.VirtualServer.Server.Socket.ReadSpecifiedLength(sizeOfData,ms);
