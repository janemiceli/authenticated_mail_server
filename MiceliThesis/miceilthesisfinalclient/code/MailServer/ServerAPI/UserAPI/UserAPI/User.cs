    ...
    public class User
    {
        ...
        public void Commit()
        {
            ...
            */
            ...
            // Call TCP AddUser
            m_pVirtualServer.Server.Socket.WriteLine("UpdateUser " + 
        ...
        public long MailboxSize
        {
            get{ 
                ...
                */
                ...
                m_pVirtualServer.Server.Socket.WriteLine("GetUserMailboxSize " + 
                    m_pVirtualServer.VirtualServerID + " " + 
                    TextUtils.QuoteString(m_UserID)
                );
        ...
        public DateTime LastLogin
        {
            get{
                ...
                */
                ...
                m_pVirtualServer.Server.Socket.WriteLine("GetUserLastLoginTime " + 
                    m_pVirtualServer.VirtualServerID + " " + 
                    TextUtils.QuoteString(m_UserID)
                );
