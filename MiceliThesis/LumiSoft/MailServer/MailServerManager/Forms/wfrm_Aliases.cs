...
{
	/// <summary>
	/// Summary description for wfrm_Aliases.
	/// </summary>
	public class wfrm_Aliases : System.Windows.Forms.Form
	{
		...
		private DataView  m_DvAliases = null;
		...
		private void m_pDomains_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			if(m_DvAliases != null){
				if(m_pDomains.SelectedItem.ToString() == "ALL"){				
					m_DvAliases.RowFilter = "";
				}
				else{				
					m_DvAliases.RowFilter = "DomainID='" + m_pDomains.SelectedItem.Tag.ToString() + "'";
				}
			}
		}
		...
		public void RefreshForm()
		{
			...
			m_DvAliases = m_ServerAPI.GetAliasesList("ALL");
			grid.DataSource = m_DvAliases;
		...
		{							
			...
			ts1.MappingName = "Aliases";			
      					
			DataGridNoActiveCellColumn TextCol = new DataGridNoActiveCellColumn();
			TextCol.MappingName = "AliasName";
			TextCol.HeaderText = "AliasName Name";
			TextCol.Width = 273;
			...
			TextCol3.MappingName = "AliasMembers";
			TextCol3.HeaderText = "Members";
			TextCol3.Width = 545;
